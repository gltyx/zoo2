...
IZ.loadZoo = function () {
	...
	for (var i=0; i<IZ.Zoo.animals.length; i++) {
		...
		'<a class="tooltip2" href="#">' + '<img class="image" src="images/' + image + '" />' + 
...
IZ.loadBadges = function () {
	...
	// for individuals of each species
		board = board + '<div class="badges" id="speciesAmount' + i + '1"><a class="tooltip" href="#"><img src="images/' + i + '.jpg" height=48 width=48><span class="tt">You got 1 ' + IZ.animals[i].name + ' in your Zoo</span></a></div>'
		board = board + '<div class="badges" id="speciesAmount' + i + '100"><a class="tooltip" href="#"><img src="images/' + i + '.jpg" height=48 width=48><span class="tt">You got 100 ' + IZ.animals[i].plural + ' in your Zoo</span></a></div>'
		board = board + '<div class="badges" id="speciesAmount' + i + '1000"><a class="tooltip" href="#"><img src="images/' + i + '.jpg" height=48 width=48><span class="tt">You got 1,000 ' + IZ.animals[i].plural + ' in your Zoo</span></a></div>'
		board = board + '<div class="badges" id="speciesAmount' + i + '10000"><a class="tooltip" href="#"><img src="images/' + i + '.jpg" height=48 width=48><span class="tt">You got 10,000 ' + IZ.animals[i].plural + ' in your Zoo</span></a></div>'
		board = board + '<div class="badges" id="speciesAmount' + i + '100000"><a class="tooltip" href="#"><img src="images/' + i + '.jpg" height=48 width=48><span class="tt">You got 100,000 ' + IZ.animals[i].plural + ' in your Zoo</span></a></div>'

	// for born inidividuals of each species
		board = board + '<div class="badges" id="speciesBorn' + i + '1"><a class="tooltip" href="#"><img src="images/' + i + '.jpg" height=48 width=48><span class="tt">A ' + IZ.animals[i].name + ' was born in your Zoo</span></a></div>'
		board = board + '<div class="badges" id="speciesBorn' + i + '100"><a class="tooltip" href="#"><img src="images/' + i + '.jpg" height=48 width=48><span class="tt">100 ' + IZ.animals[i].plural + ' were born in your Zoo</span></a></div>'
		board = board + '<div class="badges" id="speciesBorn' + i + '1000"><a class="tooltip" href="#"><img src="images/' + i + '.jpg" height=48 width=48><span class="tt">1,000 ' + IZ.animals[i].plural + ' were born in your Zoo</span></a></div>'
		board = board + '<div class="badges" id="speciesBorn' + i + '10000"><a class="tooltip" href="#"><img src="images/' + i + '.jpg" height=48 width=48><span class="tt">10,000 ' + IZ.animals[i].plural + ' were born in your Zoo</span></a></div>'
		board = board + '<div class="badges" id="speciesBorn' + i + '100000"><a class="tooltip" href="#"><img src="images/' + i + '.jpg" height=48 width=48><span class="tt">100,000 ' + IZ.animals[i].plural + ' were born in your Zoo</span></a></div>'

	// for dead inidividuals of each species
		board = board + '<div class="badges" id="speciesDead' + i + '1"><a class="tooltip" href="#"><img src="images/' + i + 'f.jpg" height=48 width=48><span class="tt">A ' + IZ.animals[i].name + ' died in your Zoo</span></a></div>'
		board = board + '<div class="badges" id="speciesDead' + i + '100"><a class="tooltip" href="#"><img src="images/' + i + 'f.jpg" height=48 width=48><span class="tt">100 ' + IZ.animals[i].plural + ' died in your Zoo</span></a></div>'
		board = board + '<div class="badges" id="speciesDead' + i + '1000"><a class="tooltip" href="#"><img src="images/' + i + 'f.jpg" height=48 width=48><span class="tt">1,000 ' + IZ.animals[i].plural + ' died in your Zoo</span></a></div>'
		board = board + '<div class="badges" id="speciesDead' + i + '10000"><a class="tooltip" href="#"><img src="images/' + i + 'f.jpg" height=48 width=48><span class="tt">10,000 ' + IZ.animals[i].plural + ' died in your Zoo</span></a></div>'
		board = board + '<div class="badges" id="speciesDead' + i + '100000"><a class="tooltip" href="#"><img src="images/' + i + 'f.jpg" height=48 width=48><span class="tt">100,000 ' + IZ.animals[i].plural + ' died in your Zoo</span></a></div>'

	// for bought inidividuals of each species
		board = board + '<div class="badges" id="speciesBought' + i + '1"><a class="tooltip" href="#"><img src="images/' + i + '.jpg" height=48 width=48><span class="tt">You bought a ' + IZ.animals[i].name + ' for your Zoo</span></a></div>'
		board = board + '<div class="badges" id="speciesBought' + i + '100"><a class="tooltip" href="#"><img src="images/' + i + '.jpg" height=48 width=48><span class="tt">You bought 100 ' + IZ.animals[i].plural + ' for your Zoo</span></a></div>'
		board = board + '<div class="badges" id="speciesBought' + i + '1000"><a class="tooltip" href="#"><img src="images/' + i + '.jpg" height=48 width=48><span class="tt">You bought 1,000 ' + IZ.animals[i].plural + ' for your Zoo</span></a></div>'
		board = board + '<div class="badges" id="speciesBought' + i + '10000"><a class="tooltip" href="#"><img src="images/' + i + '.jpg" height=48 width=48><span class="tt">You bought 10,000 ' + IZ.animals[i].plural + ' for your Zoo</span></a></div>'
		board = board + '<div class="badges" id="speciesBought' + i + '100000"><a class="tooltip" href="#"><img src="images/' + i + '.jpg" height=48 width=48><span class="tt">You bought 100,000 ' + IZ.animals[i].plural + ' for your Zoo</span></a></div>'

	// for sold individuals of each species
		board = board + '<div class="badges flipped" id="speciesSold' + i + '1"><a class="tooltip" href="#"><img src="images/' + i + 'f.jpg" height=48 width=48><span class="tt">You sold 1 ' + IZ.animals[i].name + ' from your Zoo</span></a></div>'
		board = board + '<div class="badges flipped" id="speciesSold' + i + '100"><a class="tooltip" href="#"><img src="images/' + i + 'f.jpg" height=48 width=48><span class="tt">You sold 100 ' + IZ.animals[i].plural + ' from your Zoo</span></a></div>'
		board = board + '<div class="badges flipped" id="speciesSold' + i + '1000"><a class="tooltip" href="#"><img src="images/' + i + 'f.jpg" height=48 width=48><span class="tt">You sold 1,000 ' + IZ.animals[i].plural + ' from your Zoo</span></a></div>'
		board = board + '<div class="badges flipped" id="speciesSold' + i + '10000"><a class="tooltip" href="#"><img src="images/' + i + 'f.jpg" height=48 width=48><span class="tt">You sold 10,000 ' + IZ.animals[i].plural + ' from your Zoo</span></a></div>'
		board = board + '<div class="badges flipped" id="speciesSold' + i + '100000"><a class="tooltip" href="#"><img src="images/' + i + 'f.jpg" height=48 width=48><span class="tt">You sold 100,000 ' + IZ.animals[i].plural + ' from your Zoo</span></a></div>'
		
	// for boosts of each species
		board = board + '<div class="badges" id="speciesBR' + i + '10"><a class="tooltip" href="#"><img src="images/' + i + '.jpg" height=48 width=48><span class="tt">You bought 10 birth-rate boosts for your ' + IZ.animals[i].plural + '</span></a></div>'
		board = board + '<div class="badges" id="speciesBR' + i + '20"><a class="tooltip" href="#"><img src="images/' + i + '.jpg" height=48 width=48><span class="tt">You maxed out the birth-rate of your ' + IZ.animals[i].plural + '</span></a></div>'
		board = board + '<div class="badges" id="speciesDR' + i + '10"><a class="tooltip" href="#"><img src="images/' + i + 'f.jpg" height=48 width=48><span class="tt">You bought 10 death-rate reductions for your ' + IZ.animals[i].plural + '</span></a></div>'
		board = board + '<div class="badges" id="speciesDR' + i + '20"><a class="tooltip" href="#"><img src="images/' + i + 'f.jpg" height=48 width=48><span class="tt">You minimized the death-rate of your ' + IZ.animals[i].plural + '</span></a></div>'
		board = board + '<div class="badges" id="speciesBS' + i + '10"><a class="tooltip" href="#"><img src="images/' + i + '.jpg" height=48 width=48><span class="tt">You bought 10 price boosts for your ' + IZ.animals[i].plural + '</span></a></div>'
		board = board + '<div class="badges" id="speciesBS' + i + '20"><a class="tooltip" href="#"><img src="images/' + i + '.jpg" height=48 width=48><span class="tt">You maxed out the price of your ' + IZ.animals[i].plural + '</span></a></div>'
		board = board + '<div class="badges" id="speciesEN' + i + '10"><a class="tooltip" href="#"><img src="images/' + i + '.jpg" height=48 width=48><span class="tt">10 times you bought bigger enclosures for your ' + IZ.animals[i].plural + '</span></a></div>'
		board = board + '<div class="badges" id="speciesEN' + i + '20"><a class="tooltip" href="#"><img src="images/' + i + '.jpg" height=48 width=48><span class="tt">20 times you bought bigger enclosures for your ' + IZ.animals[i].plural + '</span></a></div>'
		board = board + '<div class="badges" id="speciesEN' + i + '50"><a class="tooltip" href="#"><img src="images/' + i + '.jpg" height=48 width=48><span class="tt">50 times you bought bigger enclosures for your ' + IZ.animals[i].plural + '</span></a></div>'
		board = board + '<div class="badges" id="speciesEN' + i + '100"><a class="tooltip" href="#"><img src="images/' + i + '.jpg" height=48 width=48><span class="tt">100 times you bought bigger enclosures for your ' + IZ.animals[i].plural + '</span></a></div>'
	}

	// for total number of animals
	board = board + '<div class="badges" id="totalAmount1"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You obtained 1 animal for your Zoo</span></a></div>'
	board = board + '<div class="badges" id="totalAmount100"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You obtained 100 animals for your Zoo</span></a></div>'
	board = board + '<div class="badges" id="totalAmount1000"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You obtained 1,000 animals for your Zoo</span></a></div>'
	board = board + '<div class="badges" id="totalAmount10000"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You obtained 10,000 animals for your Zoo</span></a></div>'
	board = board + '<div class="badges" id="totalAmount100000"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You obtained 100,000 animals for your Zoo</span></a></div>'
	board = board + '<div class="badges" id="totalAmount1000000"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You obtained 1,000,000 animals for your Zoo</span></a></div>'
	board = board + '<div class="badges" id="totalAmount10000000"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You obtained 10,000,000 animals for your Zoo</span></a></div>'

	// for number of species found
	board = board + '<div class="badges" id="speciesFound10"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You found ten different species for your Zoo</span></a></div>'
	board = board + '<div class="badges" id="speciesFound20"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You found twenty different species for your Zoo</span></a></div>'
	board = board + '<div class="badges" id="speciesFound30"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You found thirty different species for your Zoo</span></a></div>'
	board = board + '<div class="badges" id="speciesFound35"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You found thirty five species species for your Zoo. You have them all!</span></a></div>'

	// for number of birthrate boosts bought
	board = board + '<div class="badges" id="brBoosts1"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You bought the first birth rate boost for your Zoo</span></a></div>'
	board = board + '<div class="badges" id="brBoosts10"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You bought 10 birth rate boosts for your Zoo</span></a></div>'
	board = board + '<div class="badges" id="brBoosts100"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You bought 100 birth rate boosts for your Zoo</span></a></div>'
	board = board + '<div class="badges" id="brBoosts200"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You bought 200 birth rate boosts for your Zoo</span></a></div>'
	board = board + '<div class="badges" id="brBoosts500"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You bought 500 birth rate boosts for your Zoo</span></a></div>'

	// for number of deathrate mitigators bought
	board = board + '<div class="badges" id="drBoosts1"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You bought the first death rate mitigator for your Zoo</span></a></div>'
	board = board + '<div class="badges" id="drBoosts10"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You bought 10 death rate mitigators for your Zoo</span></a></div>'
	board = board + '<div class="badges" id="drBoosts100"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You bought 100 death rate mitigators for your Zoo</span></a></div>'
	board = board + '<div class="badges" id="drBoosts200"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You bought 200 death rate mitigators for your Zoo</span></a></div>'
	board = board + '<div class="badges" id="drBoosts500"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You bought 500 death rate mitigators for your Zoo</span></a></div>'

	// for number of price boosts bought
	board = board + '<div class="badges" id="bsBoosts1"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You bought the first price boost for your Zoo</span></a></div>'
	board = board + '<div class="badges" id="bsBoosts10"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You bought 10 price boosts for your Zoo</span></a></div>'
	board = board + '<div class="badges" id="bsBoosts100"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You bought 100 price boosts for your Zoo</span></a></div>'
	board = board + '<div class="badges" id="bsBoosts200"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You bought 200 price boosts for your Zoo</span></a></div>'
	board = board + '<div class="badges" id="bsBoosts500"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You bought 500 price boosts for your Zoo</span></a></div>'

	// for number of enclosure boosts bought
	board = board + '<div class="badges" id="enBoosts1"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You bought the first enclosure extension for your Zoo</span></a></div>'
	board = board + '<div class="badges" id="enBoosts100"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You bought 100 enclosure extensions for your Zoo</span></a></div>'
	board = board + '<div class="badges" id="enBoosts200"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You bought 200 enclosure extensions for your Zoo</span></a></div>'
	board = board + '<div class="badges" id="enBoosts500"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You bought 500 enclosure extensions for your Zoo</span></a></div>'
	board = board + '<div class="badges" id="enBoosts1000"><a class="tooltip" href="#"><img src="images/egg.jpg" height=48 width=48><span class="tt">You bought 1000 enclosure extensions for your Zoo</span></a></div>'

	// for time played
	board = board + '<div class="badges" id="time100"><a class="tooltip" href="#"><img src="images/clock.jpg" height=48 width=48><span class="tt">Time played: 100 seconds</span></a></div>'
	board = board + '<div class="badges" id="time1000"><a class="tooltip" href="#"><img src="images/clock.jpg" height=48 width=48><span class="tt">Time played: 1,000 seconds</span></a></div>'
	board = board + '<div class="badges" id="time10000"><a class="tooltip" href="#"><img src="images/clock.jpg" height=48 width=48><span class="tt">Time played: 10,000 seconds</span></a></div>'
	board = board + '<div class="badges" id="time100000"><a class="tooltip" href="#"><img src="images/clock.jpg" height=48 width=48><span class="tt">Time played: 100,000 seconds</span></a></div>'
	board = board + '<div class="badges" id="time1000000"><a class="tooltip" href="#"><img src="images/clock.jpg" height=48 width=48><span class="tt">Time played: 1,000,000 seconds</span></a></div>'
